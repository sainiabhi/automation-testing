...
console.log(
  "-".repeat(50) + "Taking the following config setup to run" + "-".repeat(50)
);
console.log(config);
...
// Setting browser capabilities based on the user input on browser
...
const imageComparisonSrvc = ['image-comparison',
// The options
{
    // Some options, see the docs for more
    baselineFolder: join(process.cwd(), './tests/screenBaseline/'),
...
if (runTimeBrowser == "chrome") {
  runTimeServices = ["chromedriver", imageComparisonSrvc];
  runTimeCapabilities = [
    {
  ...
  runTimeServices = ["geckodriver", imageComparisonSrvc];
  runTimeCapabilities = [
    {
      maxInstances: maxBrowserInstance,
      browserName: "firefox",
